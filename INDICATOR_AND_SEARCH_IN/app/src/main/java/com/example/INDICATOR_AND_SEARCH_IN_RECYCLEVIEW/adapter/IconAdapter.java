package com.example.INDICATOR_AND_SEARCH_IN_RECYCLEVIEW.adapter;
...
import com.example.INDICATOR_AND_SEARCH_IN_RECYCLEVIEW.R;
...
public class IconAdapter extends RecyclerView.Adapter<IconAdapter.IconHolder> {
    ...
    public IconHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_icon_promotion, parent,
        false);
